...
sub make {
    ...
    while (($res_p == 0 ) || ($res_q == 0 )) {
        # 乱数でベースを選ぶ
        my $n1 = int(rand(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999));
        my $n2 = int(rand(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999));

        if ( $n1 == $n2 ) {
            $n2 = int(rand(9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999));
        }
