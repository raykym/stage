...
my $str2 = '211';
my $obj2 = Myapps::Primechk->new($str2);
...
subtest 'divisor check' => sub {
   ...
   $obj2 = Myapps::Primechk->new(1071,1029);
...
subtest 'gcd check' => sub {
   ...
   my $obj3 = Myapps::Primechk->new(1777,1999);
...
subtest 'axby1 check' => sub {
   ...
   my $obj4 = Myapps::Primechk->new(10000009247,10000009249);
